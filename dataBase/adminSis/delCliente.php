<?php
    ...
    if(isset($_GET['id'])){  //si existe el dato id mediante el metodo $_GET
        ...
        $query = "DELETE FROM clientes WHERE idCliente=$id";  //sentencia  // eliminar en la tabla task toda la fila mediante el id
        ...
        header("Location:../../adminSis/consoClientes.php");  // enviar a la pagina xxxx.php
    }
