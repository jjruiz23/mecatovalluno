                        ...
                        <div class="form-row">
                            <div class="col-sm-12">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="form-row">  <!-- primer form-row-->
                                        <div class="table-responsive">
                                        <table class="table table-sm table-striped"> <!-- tabla con campos pequeños -->

                                            <thead class="thead-dark"> <!-- para resaltar encabezados -->
                                            ...
                                            <tbody>  <!--para rellenar campos-->
                                                <?php //lienas php
                                                    ...
                                                    while($row =mysqli_fetch_array($result_estudiantes)){ ?>
                                                        <?php $fila=$fila+1;?> <!-- actualizo variable y la uso como operador de incremento para identificar indice de filas -->
                                                        <tr>  <!-- mostrar filas con los resultados -->
                                                            ...
                                                            <td> <!--enviar a edit.php pero pasando el dato de id de bd mediante php-->
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            $('#buscar').click(function() {
                                if ($('#buscador').val() == '') {
                                    alertify.alert("Ingresar Codigo");
                                    return false;
                                }
                            }); //.click(funtion)
                        }); //.ready(function)
