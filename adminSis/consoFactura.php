    ...
    <div class="row-justify">    <!-- distribuidor de columnas/filas -->
        <div class="col-sm-12 col-xs-12">    <!-- tamaños de distribucion de columnas/filas -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="crearFactura.php" class="btn btn-outline-success">Crear Factura</a>    <!--boton -->
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div style="text-align: center;">
                                        <div class="table-responsive table-bordered border-success">
                                            ...
                                            <h5 class="card-title">Consolidado General de Facturas</h5>
                                                ...
                                                <?php //lienas php
                                                    include '../dataBase/adminSis/queryConsoFacturas.php'; // invoco el query en directorio
                                                    while ($row = mysqli_fetch_row($resultConsoFactura)) { // separar tuplas de datos del resultado sql
                                                        $fila = $fila + 1;  //incrementador contador de filas
                                                        $idf =  intval($row[0]); // guardar dato tipo string mediante castin
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row[9]." ".$row[1]?></td> <!-- o por la posicion dada en el query de consutlta -->
                                                    <td><?= $row[3]." ".$row[2]?></td> <!-- imprimir el dato mediante la variable $row de $result -->
                                                    ...
                                                    <td><?= $row[7] ?></td> <!-- se puede indicar mediante el nombre del indice de la tabla de bd -->
                                                    <td><?= $row[8] ?></td> <!-- se puede indicar mediante el nombre del indice de la tabla de bd -->
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="detaFact.php?id=<?php echo $idf ?>" id="detalleFactura" class="btn btn-light border-success btn-outline-dark">
                                                        ...
                                                        ?>  <!-- cierro lineas php -->
                                                        <a href="../dataBase/adminSis/delProducto.php?id=<?php echo $idd ?>" onclick="return ConfirmarAccionDel()" id="impFactura" class="btn btn-light border-success btn-outline-dark">
                                                            <img src="../includes/images/imp2.jpg" height="17">
                                                        </a>
