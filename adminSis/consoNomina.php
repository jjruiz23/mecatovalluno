    ...
    <div class="row-justify">    <!-- distribuidor de columnas/filas -->
        <div class="col-sm-12 col-xs-12">    <!-- tamaños de distribucion de columnas/filas -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="crearFactura.php" class="btn btn-outline-success">Crear</a>    <!--boton -->
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div style="text-align: center;">
                                        <div class="table-responsive table-bordered border-success">
                                            ...
                                            <h5 class="card-title">Consolidado General de Nomina</h5>
                                                ...
                                                <?php //lienas php
                                                    include '../dataBase/adminSis/queryConsoNomina.php'; // invoco el query en directorio
                                                    while ($row = mysqli_fetch_row($resultConsoPagNom)) { // separar tuplas de datos del resultado sql
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row[3] ?></td> <!-- o por la posicion dada en el query de consutlta -->
                                                    <td><?= $row[4] ?></td> <!-- imprimir el dato mediante la variable $row de $result -->
