                                    ...
                                    <div class="table-responsive table-bordered border-success">
                                            ...
                                            <h5 class="card-title">Consolidado General de Clientes</h5>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php //lineas php
                                                    include '../dataBase/adminSis/detallesCliente.php'; // invoco el query en directorio
                                                    while ($row = mysqli_fetch_row($resultadoClienteDet)) { // separar tuplas de datos del resultado sql
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row[10] ?></td> <!-- o por la posicion dada en el query de consutlta -->
                                                    <td><?= $row[6] ?></td> <!-- imprimir el dato mediante la variable $row de $result -->
