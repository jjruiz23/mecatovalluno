<?php //inicio el php
	...
	$conexion=conexion();  //creo variable $conexion y le asigno los valores de la funcion conexion importada por conexion.hp
		...
		if(buscaCambios($conexion,$categoria,$codiProducto,$nomProducto,$preProducto,$idProducto,$cantProducto)==1){  // si el resultado de la funcion es igual a 10'
			...
			$query="UPDATE pruducto set nomProducto='$nomProducto', codiProducto='$codiProducto', idCategoria='$categoria', precioProducto='$preProducto', cantProd='$cantProducto'
		...
		function buscaCambios($conexion,$categ,$codiPro,$nomPro,$prePro,$idPro,$cantProd){  
			...
			precioProducto='$prePro', cantProd=='$cantProd"; 
