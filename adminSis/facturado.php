    ...
    <div class="row-justify"> <!-- distribuidor de columnas/filas -->
      ...
      <div class="card">
        ...
        <form id="frmRegistro">
          ...
          <a href="crearFactura.php" class="btn btn-success" style="margin-left: 370px">Crer Nueva Factura</a> <!--boton -->
          <a href="consoInvProd.php" class="btn btn-outline-success" style="margin-left: 40px">Consolidado</a> <!--boton -->
        </div>  <!--card-body-->
      </div>  <!--card-->    
