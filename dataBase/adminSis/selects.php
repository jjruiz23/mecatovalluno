<?php
    ...
    $idPersonal=$_SESSION['idPersonal'];   //se almacenan los datos de $usuario en la seccion ['idPrmiso']
    ...
    $resultadoProducto = mysqli_query($conexion, "SELECT  p.idProducto, p.nomProducto, p.codiProducto, c.nomCategoria, p.precioProducto, DATE(p.fechaCreacionProducto)
                                                        FROM pruducto p
