<?php
    ...
    if(isset($_GET['id'])){  //si existe el dato id mediante el metodo $_GET
        ...
        $query = "DELETE FROM sede WHERE idSede=$id";  //sentencia  // eliminar en la tabla task toda la fila mediante el id
        ...
        header("Location:../../adminSis/consoTiendas.php");  // enviar a la pagina xxxx.php
    }
