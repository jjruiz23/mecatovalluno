<?php //inicio el php
	...
	$conexion=conexion();  //creo variable $conexion y le asigno los valores de la funcion conexion importada por conexion.hp
		...
		if(buscaCambios($conexion,$nombres,$email,$apellidos,$fechanac,$tipodoc,$numdocumento,$estcivil,$celular,$telefono,$direccion,$idCli)==1){  // si el resultado de la funcion es igual a 1
			...
			$query="UPDATE clientes set nomCliente='$nombres', apeCliente='$apellidos', emailCliente='$email', fechaNacCliente='$fechanac',
				...
				direCliente='$direccion' WHERE idCliente='$idCli'";
