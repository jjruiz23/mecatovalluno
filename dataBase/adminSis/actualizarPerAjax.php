<?php //inicio el php
	...
	$conexion=conexion();  //creo variable $conexion y le asigno los valores de la funcion conexion importada por conexion.hp
		...
		// funcion de buscaRepetido se responde a editPer.php mediante el echo
		if(buscaRepetido($conexion,$nombres,$email,$apellidos,$fechanac,$tipodoc,$numdocumento,$estcivil,$celular,$sede,$telefono,$salarios,$direccion,$idPer)==1){  // si el resultado de la funcion es igual a 1
		...
		function buscaRepetido($conexion,$nomb,$eml,$apelidos,$fechnc,$tipdc,$numdocmnto,$estcvl,$cellr,$sde,$telfno,$salros,$dircion,$idPr){  
